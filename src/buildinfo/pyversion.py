...
class VersionInfo:
    ...
    def _saveVersionInfo(self):
        ...
        jsonData = {'filename': self.versionInfo['filename'],
                    'separator': self.versionInfo['separator'],
                    'header': self.versionInfo['header'],
                    'date': self.versionInfo['date'],
                    'month_release_count': self.versionInfo['month_release_count'],
                    'tail': self.versionInfo['tail']}
    ...
    def initVersionInfo(self):
        self.versionInfo = {'filename': "version.py",
                            'header': 'SW_VERSION="V0.1105',
                            'separator': ".", 'date': "TE",
                            'month_release_count': 1,
                            'tail': '"'}
